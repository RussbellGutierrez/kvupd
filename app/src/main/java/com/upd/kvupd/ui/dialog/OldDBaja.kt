...
@AndroidEntryPoint
class OldDBaja : DialogFragment(), AdapterView.OnItemSelectedListener {

    private val viewmodel by activityViewModels<OldAppViewModel>()
    private var _bind: DialogBajaBinding? = null
    private val bind get() = _bind!!
    private val args: OldDBajaArgs by navArgs()
    private var cliente = 0
    private var nombre = ""
    private var ruta = 0
    private val _tag by lazy { OldDBaja::class.java.simpleName }
