...
class OldFServidor : Fragment(), MenuProvider {
    ...
    private fun updateDataRoom() {
        /*viewmodel.respseguimiento.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::seguimiento.isInitialized) {
        ...
        viewmodel.respvisita.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::visita.isInitialized) {
        ...
        viewmodel.respalta.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::alta.isInitialized) {
                        alta.estado = "Enviado"
        ...
        viewmodel.respaltadatos.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::altadatos.isInitialized) {
        ...
        viewmodel.respbaja.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::baja.isInitialized) {
                        baja.estado = "Enviado"
        ...
        viewmodel.respbajaestado.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::bajaestado.isInitialized) {
        ...
        viewmodel.resprespuesta.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::respuesta.isInitialized) {
        ...
        /*viewmodel.respfoto.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::foto.isInitialized) {
                        foto.estado = "Enviado"
        ...
        /*viewmodel.respdni.observe(viewLifecycleOwner) {
            it.getContentIfNotHandled()?.let { y ->
                when (y) {
                    is OldNetworkRetrofit.Success -> if (::dni.isInitialized) {
                        dni.estado = "Enviado"
