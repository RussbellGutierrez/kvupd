...
@AndroidEntryPoint
class OldFAltaMapa : Fragment(), OnMapReadyCallback, OnMapLongClickListener, OnMarkerClickListener,
    ...
    override fun onMapReady(p0: GoogleMap) {
        p0.also {
            ...
            map.apply {
                ...
                setOnMapLongClickListener(this@OldFAltaMapa)
                setOnMarkerClickListener(this@OldFAltaMapa)
                setOnMarkerDragListener(this@OldFAltaMapa)
                setOnInfoWindowLongClickListener(this@OldFAltaMapa)
    ...
    private fun moveCamera() {
        val location = if (OldConstant.isGPSLOCinitialized()) {
            GPS_LOC
        } else {
            lastLocation
        }
