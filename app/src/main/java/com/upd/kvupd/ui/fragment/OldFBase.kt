...
@AndroidEntryPoint
class OldFBase : Fragment(), OldOnGpsState, MenuProvider {
    ...
    private val _tag by lazy { OldFBase::class.java.simpleName }
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
        menuInflater.inflate(R.menu.oldmain_menu, menu)
    }
