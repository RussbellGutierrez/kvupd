...
import com.upd.kv.ui.dialog.DBuscar
import com.upd.kv.ui.dialog.DProgress
...
fun DialogFragment.setResume() {
    this.dialog?.window?.setLayout(Constant.D_WIDTH, Constant.D_HEIGHT)
