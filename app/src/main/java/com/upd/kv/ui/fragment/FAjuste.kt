...
import com.upd.kv.BuildConfig
import com.upd.kv.databinding.FragmentFAjusteBinding
...
class FAjuste : Fragment() {
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true) {
                override fun handleOnBackPressed() {
                    showDialog("Advertencia","Cerraremos kventas para aplicar los cambios"){ requireActivity().finishAndRemoveTask() }
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when(item.itemId) {
        android.R.id.home -> consume { showDialog("Advertencia","Cerraremos kventas para aplicar los cambios"){ requireActivity().finishAndRemoveTask() } }
